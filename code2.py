...
# --- Конфигурация ---
BOT_TOKEN = "7655792449:AAHnQi-FHjIFPVat18pL6YU3PQmajNShxuI"  # Замените на токен вашего бота
ADMIN_ID = 7790322125  # Замените на ID администратора
GAME_FIELD_SIZE = 5
BOMB_COUNT = 5
START_BALANCE = 1500
CURRENCY = "BotHub Coin"
...
async def start_command(message: types.Message, state: FSMContext):
    ...
    await state.set_state(UserState.menu)
    await message.reply("👋 Добро пожаловать в BotHub Games!",
...
async def handle_callback_query(query: types.CallbackQuery, state: FSMContext):
    ...
    if query.data == "cashout":
        ...
        history_message = (
            "📜 <b>История BotHub Games:</b>\n\n"
            "BotHub Games был создан группой энтузиастов, увлеченных идеей объединения развлечений и инновационных технологий. "
